(ns payment-orchestrator-clj.datomic.schema
  (:require [datomic.client.api :as d]
            ...
            [payment-orchestrator-clj.datomic.schema.v016 :as v016]
            [payment-orchestrator-clj.datomic.schema.v017 :as v017]
            [payment-orchestrator-clj.datomic.schema.v018 :as v018]))

(def schema (into [] (concat v001/schema v002/schema v003/schema v004/schema v005/schema v006/schema v007/schema v008/schema v009/schema v010/schema v011/schema v012/schema v013/schema v014/schema v015/schema v016/schema v017/schema v018/schema)))
